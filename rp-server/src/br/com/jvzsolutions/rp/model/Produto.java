...
@NamedQueries({
	...
	@NamedQuery(name = "Produto.search", query = "select obj from Produto obj where LOWER(obj.nome) like ?1 or (obj.codigoBarras = ?2 and obj.codigoBarras <> 0) or LOWER(obj.categoria.nome) like ?3"),
